...
public class FortificationConstructionDialog extends JDialog {
    ...
    public FortificationConstructionDialog(Faction faction, FactionOrdersPanel caller){
        ...
        instructionLabel = new JLabel(
                "Select the star system where this faction will build a fortification");
            ...
            public void actionPerformed(ActionEvent event){
                ...
                if(selectedSystem != null){
                    ...
                    if(availableRUs > cost){
                        BuildFortificationOrder order = new BuildFortificationOrder(starSystem);
